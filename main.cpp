...
void* serverIPv6Start(void* arg)
{
    ...
    struct sockaddr_in6 from;
   	...
   	sin.sin6_port = htons(port_number+1);
...
//   	}
    ...
    {
        socklen_t len = sizeof(from);
        int socket = accept(n, (struct sockaddr *) &from, &len);
...
void* serverIPv4Start(void* arg)
{
    ...
    int result = setsockopt(sockfd, SOL_SOCKET, SO_KEEPALIVE, &enable_keep_alive, sizeof(int));
